...
package alvi17.blockmaster.activities;
...
import alvi17.blockmaster.R;
import alvi17.blockmaster.components.GameState;
import alvi17.blockmaster.components.Sound;
import alvi17.blockmaster.db.HighscoreOpenHelper;
import alvi17.blockmaster.db.ScoreDataSource;
...
public class MainActivity extends ListActivity {
	 ...
	 */
	public static final String PLAYERNAME_KEY = "alvi17.blockmaster.activities.playername";
	
	/** This key is used to access the player name, which is returned as an Intent from the gameactivity upon completion (gameover).
	 *  The Package Prefix is mandatory for Intent data
	 */
	public static final String SCORE_KEY = "alvi17.blockmaster.activities.score";
