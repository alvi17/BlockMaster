...
package ibcr.blockmaster.activities;
...
import ibcr.blockmaster.R;
import ibcr.blockmaster.components.GameState;
import ibcr.blockmaster.components.Sound;
import ibcr.blockmaster.db.HighscoreOpenHelper;
import ibcr.blockmaster.db.ScoreDataSource;
...
public class MainActivity extends ListActivity {
	 ...
	 */
	public static final String PLAYERNAME_KEY = "ibcr.blockmaster.activities.playername";
	
	/** This key is used to access the player name, which is returned as an Intent from the gameactivity upon completion (gameover).
	 *  The Package Prefix is mandatory for Intent data
	 */
	public static final String SCORE_KEY = "ibcr.blockmaster.activities.score";
